...
export const projects: Project[] = [
	...
	{
		title: "Next Icons",
		description: "Next Icons je open-source knihovna moderních SVG ikon navržená speciálně pro projekty v Reactu a Next.js. Ikony jsou postavené na 24×24 gridu, mají čistý a konzistentní styl a snadno se přizpůsobují pomocí barev, velikosti nebo tříd. Knihovna je ideální pro vývojáře, kteří chtějí lehké a elegantní ikony bez zbytečné zátěže.",
	...
	},
	{
		...
		description: "Pro projekt „Socializační procházky – Ostrava“ jsme vytvořili přehledný a důvěryhodný web, který informuje o pravidelných lekcích socializace psů zdarma. Hlavní důraz byl kladen na jednoduchost, přehlednost a osobní přístup – s cílem oslovit majitele psů všech věkových kategorií. Dominantní úvodní fotografie navozuje komunitní atmosféru, doplněná o snadno dostupné sekce s událostmi, galerií a kontaktem.",
	...
	{
		title: "Simple Games",
		description: "Pro vzdělávací mobilní aplikaci Dětské hry – Slabiky jsme připravili jednoduchý a hravý webový design, který odráží cílovou skupinu – malé děti a jejich rodiče. Cílem bylo vytvořit vizuálně přitažlivé a zároveň důvěryhodné prostředí, které prezentuje výukovou hru zaměřenou na rozvoj jazykových dovedností. Použili jsme pastelové barvy, animované prvky a přehledné členění obsahu.",
